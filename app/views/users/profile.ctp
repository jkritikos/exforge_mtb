                ...
                <section class="grid_6 first">									
                    ...
                    <div class="columns">
                        <div class="grid_6 first">                                                	                       
                            <form id="form" class="form panel" action="/users/profile" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <input value="<?php echo $user['User']['fname']; ?>" type="text" name="data[User][fname]" required="required" />
                                    </div>
                                    <div class="clearfix">
                                        <label>Last Name *</label>
                                        <input value="<?php echo $user['User']['lname']; ?>" type="text" name="data[User][lname]" required="required" />
                                    </div>
                                    <div class="clearfix">
                                        <label>Email *</label>
